          ...
          <div className="pt-4 border-t border-border">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatNumber(athlete.price)} SOL</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatNumber(athlete.marketCap)} SOL</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatNumber(athlete.reserve)} SOL</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Earnings</span>
                <span className="font-medium">{formatNumber(athlete.athleteRevenue)} SOL</span>
              </div>
            </div>
          </div>
        </CardContent>
